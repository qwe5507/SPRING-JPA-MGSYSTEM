...
class PersonServiceTest {
    ...
    void getAll(){
        ...
        assertThat(result.getContent().get(0).getNamesa()).isEqualTo("martin");
        assertThat(result.getContent().get(1).getNamesa()).isEqualTo("dennis");
        assertThat(result.getContent().get(2).getNamesa()).isEqualTo("tony");
    }
    @Test
